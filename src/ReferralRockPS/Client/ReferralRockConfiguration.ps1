...
Get the configuration object 'ReferralRockConfiguration'.
...
#>
function Get-ReferralRockConfiguration {

    $Configuration = $Script:Configuration

    if ([string]::IsNullOrEmpty($Configuration["BaseUrl"])) {
        $Configuration["BaseUrl"] = "https://api.referralrock.com";
    }
...
System.Collections.Hashtable
#>
function Set-ReferralRockConfiguration {
...
None
#>
function Set-ReferralRockConfigurationApiKey {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-ReferralRockConfigurationApiKeyPrefix {
    [CmdletBinding()]
    Param(
        [string]$Id,
        [AllowEmptyString()]
...
None
#>
function Set-ReferralRockConfigurationDefaultHeader {
    [CmdletBinding()]
    Param(
        [string]$Key,
        [AllowEmptyString()]
...
System.Collections.Hashtable[]
#>
function Get-ReferralRockHostSetting {
    return ,@(
          @{
            "Url" = "https://api.referralrock.com";
...
String
#>
function Get-ReferralRockUrlFromHostSetting {
    ...
    Process {
        $Hosts = Get-ReferralRockHostSetting
...
System.Collections.Hashtable
#>
function Set-ReferralRockConfigurationHttpSigning {
    [CmdletBinding()]
    param(
    ...
    Process {
        ...
        $keyType = Get-ReferralRockKeyTypeFromFile -KeyFilePath $KeyFilePath
...
Get the configuration object 'ReferralRockConfigurationHttpSigning'.
...
[PSCustomObject]
#>
function Get-ReferralRockConfigurationHttpSigning{
